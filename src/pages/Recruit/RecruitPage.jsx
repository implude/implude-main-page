...
export default function RecruitPage() {
  ...
  const partDescription = {
    ...
    experience: {
      ...
      design: ['디자인 프로그램(어도비 등)을 사용해본 경험', '개발자와의 협업 경험', 'cmd / terminal 을 활용해본 경험'],
      planner: [
        '체계적인 커리큘럼과 함께 참여형 기획 교육을 진행해요.',
        '능률을 300% 올려주는 ‘팀워크의 정석’에 대한 교육을 진행해요.',
        '기획자로서 여러 대회에 참가해 화려한 수상실적을 쌓을 수 있어요.',
                ...
                <Col gap="3.25rem">
                  ...
                  <Col gap="3rem">
                    ...
                    <Col gap="1.5rem">
                      ...
                      <RecruitText color={'--gray-black'}>
                        <li>
                          본인만의 포트폴리오가 있다면 꼭 제출해주는게 좋아요! 지원한 분야의 포트폴리오가 아니더라도
                          좋아요. 포트폴리오가 있으면 여러분의 지원서가 훨씬 매력적으로 보인답니다.
                        </li>
                        <li>
                          개발 직군의 경우, 기술 스택을 지원서에 작성해주시는게 좋아요! 없다면 작성하지 않으셔도
                          무방합니다.
                        </li>
            ...
            <Col gap="3.25rem">
              ...
              <Col gap="3rem">
                ...
                <Col gap="1.5rem">
                  ...
                  <RecruitText color={'--gray-black'}>
                    <li>
                      편안한 분위기에서 면접을 진행하는 것을 추구해요. 압박 면접은 절대 없을테니 걱정 않고 오셔도 돼요!
                    </li>
                    <li>
                      임플루드가 면접에서 보고싶은 건 지원자님의 있는 그대로의 모습이에요. 긴장하지 않고 있는 그대로의
                      자신을 보여준다면, 매력적인 면접자가 될 수 있어요.
                    </li>
                    <li>
                      임플루드의 면접은 지원자님을 일방적으로 평가하는 자리가 아니라, 대화를 통해 임플루드에서 함께
                      성장할 수 있을지 서로를 알아보는 자리에요. 면접이 임플루드에 대한 좋은 경험이 되도록 저희도 계속
                      노력할게요!
                    </li>
                  </RecruitText>
                </Col>
            ...
            {part == 0 && (
              <Col gap="1.5rem">
                ...
                <Row justify="center" gap="1rem">
                  ...
                  >
                    <Description style={{ color: detailPartDev == 0 ? 'white' : 'var(--gray-600)' }}>
                      프론트앤드
                    </Description>
                  </PartButton>
                  <PartButton
                  ...
                  >
                    <Description style={{ color: detailPartDev == 1 ? 'white' : 'var(--gray-600)' }}>
                      백앤드
                    </Description>
                  </PartButton>
                  <PartButton
