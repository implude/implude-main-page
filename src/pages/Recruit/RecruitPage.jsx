        ...
        <Col>
          ...
          {part == 0 && (<Col gap='1.5rem'>
            ...
            <PartButton
              ...
              >
                <PartButtonText style={{ color: detailPartDev == 0 ? 'white' : 'var(--gray-600)' }}>프론트앤드</PartButtonText>
              </PartButton>
              <PartButton
              ...
              >
                <PartButtonText style={{ color: detailPartDev == 1 ? 'white' : 'var(--gray-600)' }}>백앤드</PartButtonText>
              </PartButton>
              <PartButton
              ...
              >
                <PartButtonText style={{ color: detailPartDev == 2 ? 'white' : 'var(--gray-600)' }}>앱</PartButtonText>
              </PartButton>
            </Row>
            {
              (detailPartDev == 0) &&
