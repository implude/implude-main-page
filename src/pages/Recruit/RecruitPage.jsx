        ...
        <Col>
          ...
          <>
            ...
            <Row style={{position:'relative'}}>
              <TitleCircle style={{background: '#99c8ff'}}><CircleText color='black'>지원서<br />접수</CircleText></TitleCircle>
              <TitleCircle style={{background: '#3391ff', left:'8rem'}}><CircleText color='black'>지원서<br />검토</CircleText></TitleCircle>
              <TitleCircle style={{background: '#005ecc', left:'16rem'}}><CircleText color='--gray-white'>지원서<br />결과 발표</CircleText></TitleCircle>
              <TitleCircle style={{background: '#002f66', left:'24rem'}}><CircleText color='--gray-white'>면접</CircleText></TitleCircle>
              <TitleCircle style={{background: 'black', left:'32rem'}}><CircleText color='--gray-white'>최종<br />발표</CircleText></TitleCircle>
            </Row>
            <Blank height='11rem'/>
          ...
          <>
            ...
            <ApplyButton><PartButtonText style={{color:'white'}}>지원서 작성 바로가기</PartButtonText></ApplyButton>
          </div>
          </>
